...
open class SyntaxTextView: View {
  ...
  private static func createInnerTextView() -> InnerTextView {
    ...
    return InnerTextView(usingTextLayoutManager: true)
  }
  ...
  func colorTextView(lexerForSource: (String) -> Lexer) {
    ...
    createAttributes(theme: theme, themeInfo: themeInfo, textContentStorage: textView.textContentStorage!, cachedTokens: cachedTokens, source: source)
  ...
  func createAttributes(theme: SyntaxColorTheme, themeInfo: ThemeInfo, textContentStorage: NSTextContentStorage, cachedTokens: [CachedToken], source: String) {
    
  
    
    textContentStorage.performEditingTransaction {
      guard let textStorage = textContentStorage.textStorage else {
        fatalError("Missing TextStorage")
      }
